...
var foo2 = function (i, $con3, $con6, $con9, $con12) {	
	$('.van' + i + ' .carousel_more').bind("click", function(){
		...
		if (mywidth < 734) {
		 ...
		 if(i==1 ){ $("#content_prog2 .zakaz").css('color', '#086cb4');}
		 if(i==2 ){ $("#content_prog2 .zakaz").css('color', '#f15959');}
		 if(i==3 ){ $("#content_prog4 .zakaz").css('color', '#6ca018');}
		 if(i==4 ){ $("#content_prog4 .zakaz").css('color', '#f37100');}
		 if(i==5 ){ $("#content_prog6 .zakaz").css('color', '#8576fc');}
		 if(i==6 ){ $("#content_prog6 .zakaz").css('color', '#000000');}
		 if(i==7 ){ $("#content_prog8 .zakaz").css('color', '#cf5cc0');}
		 if(i==8 ){ $("#content_prog8 .zakaz").css('color', '#1fb15a');}
		 if(i==9 ){ $("#content_prog10 .zakaz").css('color', '#ed6a46');}
		 if(i==10 ){ $("#content_prog10 .zakaz").css('color', '#0ba5aa');}
		 if(i==11 ){ $("#content_prog12 .zakaz").css('color', '#ca3965');}
		 if(i==12 ){ $("#content_prog12 .zakaz").css('color', '#7751af');} 
		}
		if (mywidth < 680) {
			
		 j=i;
		 
		 if(i==1 ){ $("#content_prog1 .zakaz").css('color', '#086cb4');}
		 if(i==2 ){ $("#content_prog2 .zakaz").css('color', '#f15959');}
		 if(i==3 ){ $("#content_prog3 .zakaz").css('color', '#6ca018');}
		 if(i==4 ){ $("#content_prog4 .zakaz").css('color', '#f37100');}
		 if(i==5 ){ $("#content_prog5 .zakaz").css('color', '#8576fc');}
		 if(i==6 ){ $("#content_prog6 .zakaz").css('color', '#000000');}
		 if(i==7 ){ $("#content_prog7 .zakaz").css('color', '#cf5cc0');}
		 if(i==8 ){ $("#content_prog8 .zakaz").css('color', '#1fb15a');}
		 if(i==9 ){ $("#content_prog9 .zakaz").css('color', '#ed6a46');}
		 if(i==10 ){ $("#content_prog10 .zakaz").css('color', '#0ba5aa');}
		 if(i==11 ){ $("#content_prog11 .zakaz").css('color', '#ca3965');}
		 if(i==12 ){ $("#content_prog12 .zakaz").css('color', '#7751af');} 
		} 
		//--------------------------------
		// end adaptive design
